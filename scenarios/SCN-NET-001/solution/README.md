...
>
> — [Security Rules](https://docs.oracle.com/en-us/iaas/Content/Network/Concepts/securityrules.htm), Oracle Cloud Infrastructure documentation
...
- If a service is meant to be internal only, don't rely on network
  controls alone — put a load balancer or reverse proxy in front of it,
  or don't assign it a public IP in the first place.
